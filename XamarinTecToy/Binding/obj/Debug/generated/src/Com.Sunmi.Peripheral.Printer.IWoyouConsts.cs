...
namespace Com.Sunmi.Peripheral.Printer {
	...
	[Register ("com/sunmi/peripheral/printer/WoyouConsts", DoNotGenerateAcw=true)]
	[global::System.Obsolete (@"Use the 'WoyouConsts' type. This type will be removed in a future release.", error: true)]
	public abstract class WoyouConstsConsts : WoyouConsts {
		private WoyouConstsConsts ()
		{
		}
