...
namespace Com.Hoho.Android.Usbserial.Driver {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver']"
	[global::Android.Runtime.Register ("com/hoho/android/usbserial/driver/ProlificSerialDriver", DoNotGenerateAcw=true)]
	public partial class ProlificSerialDriver : global::Java.Lang.Object, global::Com.Hoho.Android.Usbserial.Driver.IUsbSerialDriver {
		// Metadata.xml XPath class reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver.ProlificSerialPort']"
		[global::Android.Runtime.Register ("com/hoho/android/usbserial/driver/ProlificSerialDriver$ProlificSerialPort", DoNotGenerateAcw=true)]
		public partial class ProlificSerialPort : global::Com.Hoho.Android.Usbserial.Driver.CommonUsbSerialPort {
			static readonly JniPeerMembers _members = new XAPeerMembers ("com/hoho/android/usbserial/driver/ProlificSerialDriver$ProlificSerialPort", typeof (ProlificSerialPort));
			...
			protected ProlificSerialPort (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
			{
			}

			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver.ProlificSerialPort']/constructor[@name='ProlificSerialDriver.ProlificSerialPort' and count(parameter)=3 and parameter[1][@type='com.hoho.android.usbserial.driver.ProlificSerialDriver'] and parameter[2][@type='android.hardware.usb.UsbDevice'] and parameter[3][@type='int']]"
			[Register (".ctor", "(Lcom/hoho/android/usbserial/driver/ProlificSerialDriver;Landroid/hardware/usb/UsbDevice;I)V", "")]
			public unsafe ProlificSerialPort (global::Com.Hoho.Android.Usbserial.Driver.ProlificSerialDriver __self, global::Android.Hardware.Usb.UsbDevice p0, int p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
...
#pragma warning disable 0169
			...
			{
				var __this = global::Java.Lang.Object.GetObject<global::Com.Hoho.Android.Usbserial.Driver.ProlificSerialDriver.ProlificSerialPort> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return JNIEnv.ToLocalJniHandle (__this.ControlLines);
			}
#pragma warning restore 0169

			public override unsafe global::Java.Util.EnumSet ControlLines {
				// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver.ProlificSerialPort']/method[@name='getControlLines' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			public override unsafe global::Com.Hoho.Android.Usbserial.Driver.IUsbSerialDriver Driver {
				// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver.ProlificSerialPort']/method[@name='getDriver' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			public override unsafe global::Java.Util.EnumSet SupportedControlLines {
				// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver.ProlificSerialPort']/method[@name='getSupportedControlLines' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver.ProlificSerialPort']/method[@name='closeInt' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver.ProlificSerialPort']/method[@name='openInt' and count(parameter)=1 and parameter[1][@type='android.hardware.usb.UsbDeviceConnection']]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver.ProlificSerialPort']/method[@name='setParameters' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/hoho/android/usbserial/driver/ProlificSerialDriver", typeof (ProlificSerialDriver));
		...
		protected ProlificSerialDriver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver']/constructor[@name='ProlificSerialDriver' and count(parameter)=1 and parameter[1][@type='android.hardware.usb.UsbDevice']]"
		[Register (".ctor", "(Landroid/hardware/usb/UsbDevice;)V", "")]
		public unsafe ProlificSerialDriver (global::Android.Hardware.Usb.UsbDevice p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Hoho.Android.Usbserial.Driver.ProlificSerialDriver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Device);
		}
#pragma warning restore 0169

		public virtual unsafe global::Android.Hardware.Usb.UsbDevice Device {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver']/method[@name='getDevice' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<global::Com.Hoho.Android.Usbserial.Driver.IUsbSerialPort> Ports {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver']/method[@name='getPorts' and count(parameter)=0]"
		...
		public static unsafe global::System.Collections.Generic.IDictionary<global::Java.Lang.Integer, int[]> SupportedDevices {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='ProlificSerialDriver']/method[@name='getSupportedDevices' and count(parameter)=0]"
