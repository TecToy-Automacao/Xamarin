...
namespace Com.Hoho.Android.Usbserial.Driver {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver']"
	[global::Android.Runtime.Register ("com/hoho/android/usbserial/driver/Ch34xSerialDriver", DoNotGenerateAcw=true)]
	public partial class Ch34xSerialDriver : global::Java.Lang.Object, global::Com.Hoho.Android.Usbserial.Driver.IUsbSerialDriver {
		// Metadata.xml XPath class reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver.Ch340SerialPort']"
		[global::Android.Runtime.Register ("com/hoho/android/usbserial/driver/Ch34xSerialDriver$Ch340SerialPort", DoNotGenerateAcw=true)]
		public partial class Ch340SerialPort : global::Com.Hoho.Android.Usbserial.Driver.CommonUsbSerialPort {
			static readonly JniPeerMembers _members = new XAPeerMembers ("com/hoho/android/usbserial/driver/Ch34xSerialDriver$Ch340SerialPort", typeof (Ch340SerialPort));
			...
			protected Ch340SerialPort (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
			{
			}

			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver.Ch340SerialPort']/constructor[@name='Ch34xSerialDriver.Ch340SerialPort' and count(parameter)=3 and parameter[1][@type='com.hoho.android.usbserial.driver.Ch34xSerialDriver'] and parameter[2][@type='android.hardware.usb.UsbDevice'] and parameter[3][@type='int']]"
			[Register (".ctor", "(Lcom/hoho/android/usbserial/driver/Ch34xSerialDriver;Landroid/hardware/usb/UsbDevice;I)V", "")]
			public unsafe Ch340SerialPort (global::Com.Hoho.Android.Usbserial.Driver.Ch34xSerialDriver __self, global::Android.Hardware.Usb.UsbDevice p0, int p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
...
#pragma warning disable 0169
			...
			{
				var __this = global::Java.Lang.Object.GetObject<global::Com.Hoho.Android.Usbserial.Driver.Ch34xSerialDriver.Ch340SerialPort> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return JNIEnv.ToLocalJniHandle (__this.ControlLines);
			}
#pragma warning restore 0169

			public override unsafe global::Java.Util.EnumSet ControlLines {
				// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver.Ch340SerialPort']/method[@name='getControlLines' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			public override unsafe global::Com.Hoho.Android.Usbserial.Driver.IUsbSerialDriver Driver {
				// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver.Ch340SerialPort']/method[@name='getDriver' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			public override unsafe global::Java.Util.EnumSet SupportedControlLines {
				// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver.Ch340SerialPort']/method[@name='getSupportedControlLines' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver.Ch340SerialPort']/method[@name='closeInt' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver.Ch340SerialPort']/method[@name='openInt' and count(parameter)=1 and parameter[1][@type='android.hardware.usb.UsbDeviceConnection']]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver.Ch340SerialPort']/method[@name='setParameters' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/hoho/android/usbserial/driver/Ch34xSerialDriver", typeof (Ch34xSerialDriver));
		...
		protected Ch34xSerialDriver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver']/constructor[@name='Ch34xSerialDriver' and count(parameter)=1 and parameter[1][@type='android.hardware.usb.UsbDevice']]"
		[Register (".ctor", "(Landroid/hardware/usb/UsbDevice;)V", "")]
		public unsafe Ch34xSerialDriver (global::Android.Hardware.Usb.UsbDevice p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Hoho.Android.Usbserial.Driver.Ch34xSerialDriver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Device);
		}
#pragma warning restore 0169

		public virtual unsafe global::Android.Hardware.Usb.UsbDevice Device {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver']/method[@name='getDevice' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<global::Com.Hoho.Android.Usbserial.Driver.IUsbSerialPort> Ports {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver']/method[@name='getPorts' and count(parameter)=0]"
		...
		public static unsafe global::System.Collections.Generic.IDictionary<global::Java.Lang.Integer, int[]> SupportedDevices {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.hoho.android.usbserial.driver']/class[@name='Ch34xSerialDriver']/method[@name='getSupportedDevices' and count(parameter)=0]"
