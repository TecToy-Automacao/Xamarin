...
namespace BR.Com.Daruma.Framework.Mobile.Gne.Sat {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='br.com.daruma.framework.mobile.gne.sat']/class[@name='EPSON']"
	[global::Android.Runtime.Register ("br/com/daruma/framework/mobile/gne/sat/EPSON", DoNotGenerateAcw=true)]
	public partial class EPSON : global::BR.Com.Daruma.Framework.Mobile.Gne.Sat.Interface_Sat {
		static readonly JniPeerMembers _members = new XAPeerMembers ("br/com/daruma/framework/mobile/gne/sat/EPSON", typeof (EPSON));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='br.com.daruma.framework.mobile.gne.sat']/class[@name='EPSON']/constructor[@name='EPSON' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='com.phi.gertec.sat.satger.SatGerLib']]"
		[Register (".ctor", "(Landroid/content/Context;Lcom/phi/gertec/sat/satger/SatGerLib;)V", "")]
		public unsafe EPSON (global::Android.Content.Context p0, global::Com.Phi.Gertec.Sat.Satger.SatGerLib p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Landroid/content/Context;Lcom/phi/gertec/sat/satger/SatGerLib;)V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::BR.Com.Daruma.Framework.Mobile.Gne.Sat.EPSON> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.NewString (__this.CodAvisoErro);
		}
#pragma warning restore 0169

		public override unsafe string CodAvisoErro {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.gne.sat']/class[@name='EPSON']/method[@name='getCodAvisoErro' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override unsafe string MsgAvisoErro {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.gne.sat']/class[@name='EPSON']/method[@name='getMsgAvisoErro' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.gne.sat']/class[@name='EPSON']/method[@name='ConsultarStatusOperacional' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.gne.sat']/class[@name='EPSON']/method[@name='ConsultarStatusOperacionalStr' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.gne.sat']/class[@name='EPSON']/method[@name='abreComunicacao' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.gne.sat']/class[@name='EPSON']/method[@name='cancelaUltimaVenda' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.gne.sat']/class[@name='EPSON']/method[@name='enviaDados' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int']]"
