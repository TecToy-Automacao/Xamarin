...
namespace BR.Com.Daruma.Framework.Mobile.Sat.Impostos {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']"
	[global::Android.Runtime.Register ("br/com/daruma/framework/mobile/sat/impostos/Pisqtde", DoNotGenerateAcw=true)]
	public partial class Pisqtde : global::Java.Lang.Object {
		static readonly JniPeerMembers _members = new XAPeerMembers ("br/com/daruma/framework/mobile/sat/impostos/Pisqtde", typeof (Pisqtde));
		...
		protected Pisqtde (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/constructor[@name='Pisqtde' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Pisqtde () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/constructor[@name='Pisqtde' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register (".ctor", "(Z)V", "")]
		public unsafe Pisqtde (bool p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/constructor[@name='Pisqtde' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe Pisqtde (string p0, string p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::BR.Com.Daruma.Framework.Mobile.Sat.Impostos.Pisqtde> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string CST {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/method[@name='getCST' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/method[@name='setCST' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/method[@name='completaDadosImposto' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/method[@name='completaXml' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/method[@name='getqBCProd' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/method[@name='getvAliqProd' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/method[@name='setqBCProd' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.daruma.framework.mobile.sat.impostos']/class[@name='Pisqtde']/method[@name='setvAliqProd' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
